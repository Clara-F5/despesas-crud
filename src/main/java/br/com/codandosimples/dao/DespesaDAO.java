...
public class DespesaDAO implements IDespesaDAO {
    ...
    public Despesa save(Despesa despesa) {
        ...
        try(Connection connection = ConnectionFactory.getConnection()){
            String sql = "INSERT INTO despesas (descricao, valor,dataD,categoria) VALUES (?, ?, ?, ?)";
            ...
            despesa.setId(resultSet.getLong(1));
    ...
    public Despesa update(Despesa despesa) {
        try(Connection connection = ConnectionFactory.getConnection()){
            String sql = "UPDATE Despesas SET descricao = ?, valor = ?, dataD = ?, categoria = ? WHERE id = ?";
    ...
    public List<Despesa> findAll() {
        String sql = "SELECT id, descricao,dataD,valor, categoria FROM despesas";
        ...
        try (Connection connection = ConnectionFactory.getConnection()){
            ...
            while (rs.next()){
              ...
              LocalDate data = rs.getDate("dataD").toLocalDate();
    ...
    public Optional<Despesa> findById(Long id) {
        String sql = "SELECT id, descricao,dataD,valor, categoria FROM despesas WHERE id = ?";
    ...
    public List<Despesa> findByCategoria(Categoria categoria) {
        String sql = "SELECT id, descricao,dataD,valor, categoria FROM despesas WHERE categoria = ?";
    ...
    @Override
    public List<Despesa> findByValor(double valor) {
        String sql = "SELECT id, descricao, dataD, valor, categoria FROM despesas WHERE valor = ?";
        ...
        try(Connection connection = ConnectionFactory.getConnection()) {
            ...
            while(rs.next()){
                ...
                Despesa despesa = new Despesa(id, descricao, data, val, categoria);
                despesas.add(despesa);
            }
